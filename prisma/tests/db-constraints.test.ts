// Automated coverage for the two DB-level constraints added in migrations
// 20260718171742_bookings_no_overlap_exclude and 20260718171756_listings_pricing_check.
...
function createSpaceListing(companyId: number, overrides: Record<string, unknown> = {}) {
...
async function cleanupCompanyAndUsers(companyId: number, userIds: string[]) {
